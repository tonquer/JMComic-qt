        ...
        while True:
            try:
                ...
                if config.CanWaifu2x:
                    ...
                    sts = waifu2x_vulkan.add(task.imgData, task.model.get('model', 0), task.downloadId, format="png", width=task.model.get("width", 0),
    ...
    def AddConvertTask(self, path, imgData, model, completeCallBack, backParam=None, cleanFlag=None, filePath=""):
        ...
        if path:
            ...
            if Setting.SavePath.value:
                ...
                info.cacheAndLoadPath = path + "_{}.png".format(a)
        if cleanFlag:
