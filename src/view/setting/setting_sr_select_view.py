...
class SettingSrSelectView(BaseMaskDialog, Ui_SrSelect):
    ...
    def Init(self):
        recommended = Str.GetStr(Str.Recommended)
        AllModelNames = [
            ...
            ("SE_UP2X_DENOISE3X","Real-CUGAN", recommended, "300%"),
            ...
            ("ANIMAVIDEOV3_UP2X","Real-ESRGAN", recommended, "200%"),
